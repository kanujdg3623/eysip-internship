                    ...
                    <form method="POST" action="{{ route('admin.update') }}" enctype="multipart/form-data" >
                        ...
                        <div class="field">
						  ...
						  <div class="control has-icons-left has-icons-right">
							<input class="input is-rounded @if ($errors->has('name')) is-danger @endif" type="text" placeholder="Name" name="name" value="{{ old('name') ?? Auth::user()->name}}">
						...
						<div class="field">
						  ...
						  <div class="control has-icons-left has-icons-right">
							<input class="input is-rounded @if ($errors->has('post')) is-danger @endif" type="text" placeholder="Post" name="post" value="{{ old('post') ?? Auth::user()->post}}">
							<span class="icon is-small is-left">
							  <i class="fas fa-user"></i>
							</span>						
						  @if ($errors->has('post'))<span class="icon is-small is-right">
							  <i class="fas fa-exclamation-triangle"></i>@endif
							</span>
						  </div>
						  @if ($errors->has('post'))
